...
///
/// Version : Goes with UnityScriptToCSharpConverter v1.0
/// Release :  
///
...
public struct Script 
{
    ...
    {
        text = p_text;
        relativePath = p_relativePath.Replace(".js", "").Replace("\\", "/");
...
public class RegexUtilities 
{
    ...
    public static string convertedCode = "";
    public static Script script;

    public static Dictionary<string, string> itemsAndTypes = new Dictionary<string, string>();
